...
:root {
    ...
    --surface-strong: rgba(238, 238, 238, 0.95);
    --ink: #0f172a;
    --soft: #5f6674;
    --accent: #f3c542;
    --accent-2: #e24a3b;
    ...
    --card-radius: 18px;
    --shadow: 0 14px 30px rgba(16, 24, 40, 0.2);
}

body.dark {
    --surface: rgba(28, 32, 43, 0.9);
    --surface-strong: rgba(34, 40, 54, 0.92);
    --ink: #e8edf7;
    --soft: #b8c1d5;
...
.search input:focus {
    outline: 2px solid rgba(242, 154, 183, 0.5);
}
...
.app-card:hover {
    ...
    border-color: rgba(243, 197, 66, 0.9);
}
...
.app-card mark {
    background: rgba(243, 197, 66, 0.45);
    color: inherit;
    border-radius: 4px;
    padding: 0 2px;
}
...
.icon.gold {
    background: linear-gradient(145deg, #f0b429, #c6820b);
}
...
/* ── Touch Fallback: mobile in desktop-site mode ── */
...
<header class="topbar">
 ...
 <div class="center-group">
        <div class="search">
            <input id="appSearch" type="text" placeholder="ابحث عن برنامج..." aria-label="بحث عن برنامج">
            <button id="clearSearch" class="search-clear hidden" type="button" aria-label="مسح البحث">✕</button>
        </div>
    </div>
...
<section class="layout">
    <aside class="side">
        <div class="side-card calendar-mini">
            <h4 id="monthLabel">-</h4>
            <div id="calendarGrid" class="calendar-grid"></div>
        </div>

        <div class="side-card clock">
            <div>(GMT+3)</div>
            <div id="time">--:--</div>
            <div id="date">-</div>
        </div>

        <div class="side-card weather">
            <div>كربلاء</div>
            <strong id="tempNow">--C</strong>
            <div id="tempRange">--C - --C</div>
            <small id="weatherState">جاري تحديث الطقس...</small>
        </div>
    </aside>
    ...
    <main class="main">
        ...
        <a class="app-card" data-id="mony" data-title="برنامج الحسابات" href="https://mony.cityimam.com/" target="_blank" rel="noopener noreferrer" draggable="true">
            ...
            <div class="icon gold" aria-hidden="true">
                <svg viewBox="0 0 24 24">
                    ...
                    <path d="M9 10.5c0-1.1.9-2 2-2h2"></path>
                    <path d="M15 10.5c0 1.1-.9 2-2 2h-2"></path>
        ...
        <a class="app-card" data-id="support" data-title="الاستفسار والدعم" href="/login" draggable="true">
            ...
            <div class="icon red" aria-hidden="true">
                <svg viewBox="0 0 24 24">
                    <path d="M4 6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H9l-5 4V6z"></path>
                    <path d="M8 9h8"></path>
                    <path d="M8 12h5"></path>
                </svg>
            </div>
